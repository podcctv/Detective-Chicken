...
func (m *Memory) seed() {
	...
	seedNodes := []model.Node{
		{ID: "node_hkg_01", TenantID: "tenant_demo", Name: "HK-CMI-01", Provider: "DMIT", Region: "香港", Family: 4, Families: []int{4, 6}, ReportedIP: "103.145.12.81", MaskedIPv4: "103.145.12.*", MaskedIPv6: "2402:4e00:1000:0:*:*:*:*", ASN: 906, Organization: "DMIT Cloud Services", CountryCode: "HK", UsageType: "机房", IPType: "原生", Latitude: 22.3193, Longitude: 114.1694, Risk: 18, Status: "online", Netflix: "available", ChatGPT: "available", Unlocks: model.NodeUnlocks{}, DNSBL: 0, LastSeen: now.Add(-42 * time.Second), LastScan: now.Add(-2 * time.Hour)},
